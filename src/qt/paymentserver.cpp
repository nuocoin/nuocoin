...
const QString BITCOIN_IPC_PREFIX("NuoCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click NuoCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start NuoCoin: click-to-pay handler");
    else
...
{
    // clicking on NuoCoin: URLs creates FileOpen events on the Mac:
